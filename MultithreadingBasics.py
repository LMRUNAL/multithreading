...
But simple lock have problem of geting block eg. if it is used in recursive function
So to solve that we use RLock means thread can acquaire same lock again but for every acquaire call release call should be there
